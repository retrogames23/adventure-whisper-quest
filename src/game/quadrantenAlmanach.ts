...
export const ALMANACH_CHAPTERS: AlmanachChapter[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "- **Schmerz-Radio.** Ein Funkgerät, das auf 104,6 MHz arbeitet und — nach Aussage seiner Hörer — *Empfindungen* überträgt, vorwiegend unangenehme. Aufgetaucht Mitte der 70er in der Bastler-Szene; ein Urheber ist nicht verzeichnet. In den 80ern als „Therapie-Spielzeug“ kurz im Handel, danach vom Markt verschwunden. Geräte stehen heute bei wenigen Sonderlingen, in Trödelläden und gelegentlich in Bewohner-Wohnungen.",
