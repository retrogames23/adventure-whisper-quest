...
const absurdChapters: HandbookChapter[] = [
  ...
  {
    id: "absurd-wartenummer",
    shortTitle: "wartenummer 847",
    title: "wartenummer 847",
    body: [
      "Die 846 wurde aufgerufen.",
      "Die 845 war schon dran.",
      "Die 844 hatte vergessen, wofür sie kam,",
      "und wurde trotzdem bedient.",
      "",
      "Ich bin die 847.",
      "Mein Stuhl knarrt im Takt der Uhr.",
      "Irgendwann werde ich aufstehen,",
      "ohne aufgerufen worden zu sein,",
      "und niemand wird es bemerken.",
      "",
      "Das ist der Witz: Ich bin bereits erledigt.",
      "Nur das Formular fehlt noch.",
    ],
  },
  {
    id: "absurd-kueche",
  ...
  {
    id: "absurd-formular",
    shortTitle: "das formular",
    title: "das formular",
    body: [
      "Gib an: deinen Namen.",
      "Gib an: den Namen, den du hättest haben können.",
      "Gib an: die Größe deiner Sehnsucht in Quadratmetern.",
      "Gib an: ob du geliebt werden möchtest oder nur bestätigt.",
      "",
      "Kreuze an: Tag. Nacht. Beides. Keines davon.",
      "Kreuze an: ob du glaubst, dass das Kreuzen etwas ändert.",
      "",
      "Unterschreibe mit der Hand, die noch zittert.",
      "Lege das Formular in den Schlitz.",
      "Der Schlitz führt in denselben Raum, aus dem du es genommen hast.",
      "Das ist der einzige Ort, an dem es hingeht.",
    ],
  },
  {
    id: "absurd-regen",
