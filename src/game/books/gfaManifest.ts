...
export const GFA_MANIFEST_CHAPTERS: HandbookChapter[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "Zwar gibt es seit kurzer Zeit ein Gesetz, das die Neueinrichtungen solcher Anlagen im Mandatgebiet Mitteleuropa verbietet, die Betreiber aber siedeln einfach in den ehemaligen Ost-Mandatsgebiete in die Naehe der Mandatsgebiet-Grenze Mitteleuropa um, um ihrer entarteten Raffgier weiter nachzukommen. Ein schlichtes Einfuhrverbot fuer solche Eier wuerde das Problem schon loesen, das sollten uns ein paar Pfennige mehr fuer unser Fruehstuecksei schon wert sein.",
