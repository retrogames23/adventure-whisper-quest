...
export const FASTWEB_LORE_GUARD = [
  ...
  "'Resonanz' und 'Resonanz-Hygiene' hast du vielleicht am Rande gehört (steht angeblich im Wetterbericht des Mandatsgebiets, so wie bei uns Pollenflug), aber du weißt nichts Konkretes darüber und lebst nicht damit. Begriffe wie 'Schmerz-Radio', 'Zentralknoten', 'Gebäude E67', 'Klang-Visite' gibt es in deiner Welt nicht.",
