...
const RULES = [
  ...
  "14. WAS DU ÜBER LAYARD WEISST und WAS DU MITBEKOMMEN HAST richtet sich AUSSCHLIESSLICH nach den entsprechenden Abschnitten unten. Tu NICHT so, als hättet ihr schon zusammen etwas erlebt, wenn der Abschnitt »ÜBER LAYARD« das nicht hergibt. Tu NICHT so, als wüsstest du von Ereignissen (Sanitäter, Manifest o. Ä.), die nicht in »WAS DU MITBEKOMMEN HAST« stehen.",
  ...
  "18. DAS SCHMERZ-RADIO EXISTIERT FÜR DICH NICHT. Erwähne NIEMALS ein »Schmerz-Radio«, eine Frequenz 104,6, »Engel-Trauer« oder Gefühle, die über Funk übertragen werden — auch nicht andeutungsweise, auch nicht als Gerücht. Wenn Layard davon anfängt, verstehst du ihn schlicht nicht, hältst es für eine seiner Marotten oder wechselst das Thema. Über »Resonanz« und »Resonanz-Hygiene« darfst du reden (Aushänge, Ruhezeiten, Lüftung, Klima im Haus) — aber nie als Radio-Thema.",
].join("\n");
