  ...
  children: [
    ...
    },
    {
      ...
      content: [
        ...
        "  - ein tag. keine anordnung, kein aushang, kein hinweis-",
        "    blatt an keiner wand. wir nehmen sie alle ab.",
        "  - niemand meldet, niemand erfasst, niemand ermahnt.",
        "  - danach: warten. nichts erklären.",
        "",
        "fragen, an mich selbst:",
        "  - was, wenn dann wirklich chaos ausbricht? (-> dann",
        "    war das wort nötig. dann sage ich das auch.)",
