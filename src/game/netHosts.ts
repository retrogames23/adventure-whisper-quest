  ...
  },
  {
    ...
    files: {
      "manifest.txt": [
        ...
        "",
        "1. »resonanz-hygiene« ist kein begriff. es ist ein platzhalter.",
        "   elf aushänge, elf bedeutungen. ruhezeiten. lüftung.",
        "   belegungsdichte. türsiegel. was heute gebraucht wird.",
        "",
        "2. die quadranten sind keine wohnform.",
        "   die quadranten sind eine sortieranlage.",
        "   du bist nicht zuhause. du bist abgelegt.",
        "",
        "3. ein wort ohne definition ist kein wort. es ist ein hebel.",
        "   wer es auslegt, entscheidet. wer es hört, gehorcht.",
        "   frag nach der definition. schriftlich.",
        "",
        "4. der weg hinaus beginnt mit einem tag der stille:",
        "   ein tag, an dem keine wand dir etwas sagt.",
