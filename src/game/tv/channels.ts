...
export const CHANNELS: Channel[] = [
  {
    ...
    bulletins: [
      ...
      "Zur Belegungslage im Quadranten E7. Die Verwaltung meldet für Oktober eine Auslastung von 94 Prozent in den medizinischen Einrichtungen. Im Vorjahresmonat waren es 88 Prozent. Eine Erklärung wurde nicht mitgeteilt.",
      ...
      "Die Preise für Grundnahrungsmittel bleiben im November stabil. Butter wird knapper: Das Kontingjent sinkt von 250 auf 200 Gramm je Person und Woche. Margarine ist nicht kontingentiert.",
      ...
      "Wetterbedingt kam es am Wochenende zu 41 Verkehrsunfällen im Sektor, davon vier mit Verletzten. Die Verkehrsstelle rät zu Winterreifen. Eine Pflicht besteht weiterhin nicht.",
      ...
      "Zur Schulstatistik. Im E-Sektor wurden in diesem Jahr 1.240 Kinder eingeschult, 60 weniger als im Vorjahr. Die Schulverwaltung führt das auf die Altersstruktur der Wohnblocks zurück.",
      ...
      "Ein Wort zur Resonanz-Hygiene. Die Zahl der Ruhezeit-Beschwerden im Sektor ist im Oktober um ein Fünftel gestiegen. Die Verwaltung bittet um wechselseitige Rücksicht, besonders in Gebäuden mit dünnen Zwischendecken.",
      ...
      "Zum Schluss die Zahl des Tages: 4.567. So viele Vorgänge hat die Leitstelle des Quadranten E7 im Oktober abgeschlossen. Es ergeht der Dank der Direktion an die Mitarbeitenden.",
      "Das war der Sektorbericht. Die nächste Ausgabe folgt zur vollen Stunde. Bleiben Sie in Regel — und einen ruhigen Abend.",
    ],
  },
  {
    id: "z2",
    name: "Bürgerfunk E-Sektor",
    ...
    bulletins: [
      "Schönen guten Abend aus dem Bürgerfunk. Ich lese vor, was diese Woche bei uns abgegeben wurde. Es sind wieder viele Zettel geworden — wir fangen einfach oben an.",
      ...
      "Hilfsgesuch. Herr Merten, 4102, sucht jemanden, der ihm beim Ausfüllen der Wohnraum-Sprawka hilft. Er sagt, er versteht die Seite vier nicht. Ehrlich gesagt versteht die hier niemand.",
  ...
  },
  {
    ...
    ticker:
      "+++ Nacht 1 bis minus 3 Grad, örtlich Nebel +++ morgen 4 Grad, Wind aus Nordost 25 km/h +++ Resonanzindex E-Sektor 2,4 (Vortag 2,3) +++ E71 bei 3,1 +++ Empfehlung: Ruhezeiten wahren, Innenräume bevorzugen +++",
    hold: 12,
    videoUrl: anchorWetterAsset.url,
    voiceId: "XB0fDUnXU5powFXDhCwa",
    accentClass: "text-cyan-200",
    bulletins: [
      "Guten Abend zur Wetter- und Resonanzlage. Zunächst das Wetter: In der Nacht sinken die Temperaturen im Sektor auf 1 bis minus 3 Grad, in den Senken örtlich Nebel mit Sichtweiten unter hundert Metern.",
      ...
      "Zur Resonanzlage. Der Resonanzindex des E-Sektors liegt heute bei 2,4 nach 2,3 am Vortag. Die Skala reicht von 0 bis 5. Werte unter 3 gelten als unauffällig.",
      ...
      "Gebäude E71: Resonanzindex 3,1, damit der höchste Wert im Quadranten. Ausschlaggebend sind 42 Krankmeldungen in der zurückliegenden Woche und eine erhöhte Belegungsdichte in Korridor 15.",
      ...
      "Gebäude E29: Resonanzindex 1,9, der niedrigste Wert im Sektor seit August. Die Bauverwaltung führt das auf die neuen Dämmschichten in den Zwischendecken zurück.",
