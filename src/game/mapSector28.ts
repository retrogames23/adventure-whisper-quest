...
export const sector28Places: MapPlace[] = [
  ...
  },
  {
    ...
    x: 20,
    y: 85,
    text: "Umschlagplatz für Nährstofflieferungen, Kohle und Rohrpost. Der Knoten hier sortiert die Kapseln aus beiden Quadranten. Bei Nasse riecht der ganze Hof nach heißem Gummi und Kantinenfett.",
  },
  {
    id: "umspannwerk",
